...
export const HandThumbUpIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 10.5v6a1.5 1.5 0 0 0 1.5 1.5h6.75a1.5 1.5 0 0 0 1.5-1.5v-6m-9.75 0V9a3 3 0 0 1 3-3h3a3 3 0 0 1 3 3v1.5m-9.75 0h9.75" />
  </svg>
);

export const HandThumbDownIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 13.5v-6a1.5 1.5 0 0 0-1.5-1.5H8.25a1.5 1.5 0 0 0-1.5 1.5v6m9.75 0V15a3 3 0 0 1-3 3h-3a3 3 0 0 1-3-3v-1.5m9.75 0H6.75" />
  </svg>
);

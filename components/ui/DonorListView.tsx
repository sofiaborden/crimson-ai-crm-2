...
const DonorListView: React.FC<DonorListViewProps> = ({ segmentId, segmentName, isOpen, onClose, segmentData }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-7xl max-h-[90vh] overflow-visible">
        ...
        {showAdvancedFilters && (
          <div className="p-4 bg-gray-100 border-b-2 border-gray-300 shadow-inner">
        ...
        <div className="p-6 border-t border-gray-200 bg-gray-50 overflow-visible">
